...
func TestRBTree_MarshalJSON(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false), 3, 2, 1, 4, 5)
...
func TestRBTree_UnmarshalJSON(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, NewRBTree[int](compare.NewNatureComparator[int](false), 1, 3, 4, 2, 5), tree)
}

func TestRBTree_ToArray(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false), 1, 3, 4, 2, 5)
	assert.Equal(t, []int{1, 2, 3, 4, 5}, tree.ToArray())
}

func TestRBTree_FromArray(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false))
...
func TestRBTree_Copy(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false), 1, 3, 4, 2, 5)
...
func TestRBTree_ContainsAny(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false), 1, 3, 4, 2, 5)
...
func TestRBTree_AddAll(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false))
...
func TestRBTree_Remove(t *testing.T) {
	tree := NewRBTree[int](compare.NewNatureComparator[int](false), 1, 2, 3, 4, 5)
	tree.Remove(1)
	tree.Remove(4)
