...
func NewLinkedList[E comparable](values ...E) *LinkedList[E] {
...
func (l *LinkedList[E]) Sort(comparer compare.Comparer[E]) {
	items := l.ToArray()
...
func (l *LinkedList[E]) SortElements(comparer compare.Comparer[*element[E]]) {
	items := []*element[E]{}
	l.RangeElement(func(element *element[E]) bool {
...
func (l *LinkedList[E]) Clone() container.Collection[E] {
	l2 := NewLinkedList[E]()
	l.Range(func(value E) bool {
		l2.Push(value)
		return true
...
func (l *LinkedList[E]) Contains(values ...E) bool {
...
func (l *LinkedList[E]) ContainsAny(values ...E) bool {
	for _, value := range values {
		if l.contains(value) {
			return true
		}
...
func (l *LinkedList[E]) LastIndexOf(value E) int {
...
func (l *LinkedList[E]) RangeElement(callback func(element *element[E]) bool) {
	for el := l.root.next; el != nil; el = el.next {
		if !callback(el) {
			break
		}
