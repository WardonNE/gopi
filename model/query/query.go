...
func First[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
...
func FirstOrFail[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
	if err := db.First(model, conditions...).Error; err != nil {
		panic(err)
	} else {
...
func FirstOrCreate[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
...
func FirstOrInit[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
...
func Last[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
...
func LastOrFail[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
	if err := db.Last(model, conditions...).Error; err != nil {
		panic(err)
	} else {
...
func Take[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
...
func TakeOrFail[T any](db *gorm.DB, conditions ...any) *T {
	var model = new(T)
	if err := db.Take(model, conditions...).Error; err != nil {
		panic(err)
	} else {
